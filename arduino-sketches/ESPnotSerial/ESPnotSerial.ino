...
#define WIFI_SSID   "HTTF"
#define WIFI_PASSWORD   "nowsunday"
#define ko 1      //子機の数12
...
void loop(){
  ...
  //Firebaseからブザーの情報を取ってくる
  buza = Firebase.getInt("sd1");
  Serial.println(buza);
  Serial.println("...");
  Firebase.setInt("sd1", 0);  // ブザー初期化
